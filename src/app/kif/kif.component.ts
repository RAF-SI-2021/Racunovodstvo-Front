...
export class KifComponent implements OnInit {
  ...
  faktura1: Faktura = new Faktura(1,"3", "20/03/2000", new Preduzece("NEBITNO"), "20/03/2000", 10000, 0,
    5, 500, 10500, 10500, "DIN", 1, 10500, "Komentar", "IZLAZNA_FAKTURA",2, "FAKTURA");

  faktura2: Faktura = new Faktura(2,"4", "20/03/2000", new Preduzece("NEBITNO"), "20/03/2000", 10000, 0,
    5, 500, 10500, 10500, "DIN", 1, 10500, "Komentar", "IZLAZNA_FAKTURA",2, "FAKTURA");
  ...
  ngOnInit(): void {
    ...
    this.service.sveFakture().subscribe((response) =>{
      this.kif = response.content.filter( e => (e.tipFakture=='IZLAZNA_FAKTURA'));
    });
  }
  ...
  filterKIF() {
    ...
    this.service.filterKIF(filter, vrednost).subscribe((response) =>{
      if(response.ok) {
