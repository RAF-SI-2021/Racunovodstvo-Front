...
export class KoeficijentiService {
  ...
  getAllKoeficijenti(){
    return this.http.get<Koeficijent[]>(environment.APIEndpoint+`/api/koeficijenti`,{
      headers : this.httpHeaders
    });
  }

  updateKoeficijent(koeficijent : Koeficijent, najnizaOsnovica : number, najvisaOsnovica : number, penzionoOsiguranje1 : number, penzionoOsiguranje2 : number, zdravstvenoOsiguranje1 : number, zdravstvenoOsiguranje2 : number){
    return this.http.put(environment.APIEndpoint+`/api/koeficijenti`,{
