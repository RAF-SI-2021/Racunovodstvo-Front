...
import {DnevnikKnjizenja} from "../../model";
...
export class KnjizenjaComponent implements OnInit {
  ...
  pretrazi() {
    this.knjizenejService.pretrazi(this.brojNaloga, this.od, this.doo, this.brojDokFak, this.komentar, this.uzetOd, this.uzetDo).subscribe((data:any)=>{
  ...
  ngOnInit(): void {
    localStorage.setItem("jwt", "eyJhbGciOiJIUzUxMiJ9.eyJzdWIiOiJ1c2VyMSIsImV4cCI6MTY0OTMxNjA4NCwiaWF0IjoxNjQ5MjgwMDg0fQ.LID1a-mPoi62Tfj8SjZYrwUu_TtoazrN2GR3LIlHUFAyXXZDN1wJVQVFrV56EmptW-3zWWyPq0nv8bloVBZ7cQ");
